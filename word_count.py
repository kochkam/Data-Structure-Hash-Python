...
def top_words(source, number):
    ...
    newList = []
    printTuple = ()
    listWords = ht.bucket_keys()  #fills a list with all nodes in bucketlist and then sorts them
...
#print(top_words("dog.txt",5))  # COMMENT THIS OUT WHEN SUBMITTING TO GRADESCOPE